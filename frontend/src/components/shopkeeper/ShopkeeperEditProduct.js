...
function ShopkeeperEditProduct({
    ...
    return <Modal show={show} onHide={cancelEditProduct}>
        <Form onSubmit={handleSubmit}>
            ...
            <Form.Control type='number' step='.01' value={unitPrice} onChange={event => updateUnitPrice(event.target.value)}/>
            <Form.Label>Units in Stock</Form.Label>
            <Form.Control type='number' value={unitsInStock} onChange={event => updateUnitsInStock(event.target.value)}/>
            ...
            <Form.Control type='discontinued' as='select' value={discontinued} defaultValue={false} onChange={event => updateDiscontinued(event.target.value)}>
                <option value={true}>True</option>
                <option value={false}>False</option>
                </Form.Control>

                <Form.Label>Picture</Form.Label>
                <Form.Control type='image' value={picture} onChange={event => updatePicture(event.target.value)}/>
